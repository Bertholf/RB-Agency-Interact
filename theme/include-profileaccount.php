	...
	foreach($results as $data) {
		...
		echo "		<div class=\"rbmessage\">\n";
					if (!empty($ProfileGallery) && is_dir(RBAGENCY_UPLOADPATH .$ProfileGallery)) {
						echo "<span class=\"updated\" style=\"display:block!important;\"><a href=\"".network_site_url("/")."profile/". $ProfileGallery ."/\" target=\"_blank\" style=\"border-bottom:0px;\">/profile/". $ProfileGallery ."/</a></span>\n";
