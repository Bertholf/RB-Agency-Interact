			...
			if ($ProfileCustomType == 1) { //TEXT
				...
				foreach($array_customOptions_values as $val){
					 ...
					 if($data3['ProfileCustomOptions']==1){
												    if($rb_agency_option_unittype == 1){
														echo "<select name=\"ProfileCustomID". $data3['ProfileCustomID'] ."\">\n";
															if (empty( $ProfileCustomValue[$data3['ProfileCustomID']])) {
														echo " 				<option value=\"\">--</option>\n";
															}
														...
														echo " <option value=\"". $i ."\" ". selected($ProfileCustomValue[$data3['ProfileCustomID']], $i) .">". $heightfeet ." ft ". $heightinch ." in</option>\n";
															  $i++;
															}
														echo " </select>\n";
												    }else{
													    echo "	 <input type=\"text\" id=\"ProfileStatHeight\"  name=\"ProfileCustomID". $data3['ProfileCustomID'] ."\" value=\"". $ProfileCustomValue[$data3['ProfileCustomID']]."\" />\n";
												    }
						 }else{
