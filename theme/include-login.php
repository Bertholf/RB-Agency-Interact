...
echo "              <li><a href=\"". get_bloginfo("wpurl") ."/profile-register/talent\" class=\"rb_button\">". __("Register as Talent / Model", rb_agencyinteract_TEXTDOMAIN). "</a></li>\n";
echo "            </ul>\n";
...
echo "              <li><a href=\"". get_bloginfo("wpurl") ."/profile-register/client\" class=\"rb_button\">". __("Register as Agent / Producer", rb_agencyinteract_TEXTDOMAIN). "</a></li>\n";
echo "            </ul>\n";
echo "          </div> <!-- talent-register -->\n";
}
echo "        </div> <!-- rbsign-up -->\n";
