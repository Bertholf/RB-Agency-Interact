...
echo "              <li>". __("Get found by studios and producers.", rb_agencyinteract_TEXTDOMAIN). "</li>\n";
echo "              <li>". __("Showcase your Talent with a photo gallery, videos and more.", rb_agencyinteract_TEXTDOMAIN). "</li>\n";
echo "            </ul>\n";
echo "            <a href=\"". get_bloginfo("wpurl") ."/sign-up/\" class=\"button orange\">". __("View Plans and Register", rb_agencyinteract_TEXTDOMAIN). "</a>\n";
...
echo "            <ul>\n";
echo "              <li>". __("Search for Talent", rb_agencyinteract_TEXTDOMAIN). "</li>\n";
echo "              <li>". __("Contact People in the Talent Directory", rb_agencyinteract_TEXTDOMAIN). "</li>\n";
echo "              <li>". __("Request Emailed List of Talents", rb_agencyinteract_TEXTDOMAIN). "</li>\n";
echo "            </ul>\n";
echo "            <a href=\"". get_bloginfo("wpurl") ."/profile-register/\" class=\"button orange\">". __("Register as Agent / Producer", rb_agencyinteract_TEXTDOMAIN). "</a>\n";
echo "          </div> <!-- talent-register -->\n";
